...
Use the bundled Python helper for deterministic repository detection, issue creation, and Project V2 Type updates. Use the LLM only for judgement: understanding the bug, expanding terse details into meaningful template prose, and confirming the exact issue before creation.
...
3. Gather enough detail for title, description, steps to reproduce, and expected behavior. Show the full title and body, then wait for explicit approval.
